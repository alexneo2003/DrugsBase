...
//                case 1:
//             здеся вторая вкладка
//                case 2:
//             здеся треять вкладка
//                case 3:
//             здеся четвертая вкладка
...
//            return PlaceholderFragment.newInstance(position + 1);
     ...
     */
    public static class DrugFragment extends Fragment {
        /**
         ...
         * number.
         */
        public static DrugFragment newInstance(int sectionNumber) {
